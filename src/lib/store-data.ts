...
export const products: Product[] = [
  ...
  {
    id: '13',
    name: 'Bondly: Truth or Dare Edition',
    description: 'The classic party game with a Bondly twist. 100 prompts to challenge your friends and reveal some secrets.',
    price: '$20.00',
    image: 'https://picsum.photos/seed/deck10/600/400',
    aiHint: 'truth dare game',
    category: 'Decks',
  },
  {
    id: '14',
    name: 'Bondly: Spicy Edition',
    description: 'For those who are feeling a little more adventurous. 100 prompts to turn up the heat.',
    price: '$20.00',
    image: 'https://picsum.photos/seed/deck11/600/400',
    aiHint: 'spicy card game',
    category: 'Decks',
  },
  {
    id: '4',
