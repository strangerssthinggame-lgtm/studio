...
export const userProfiles: UserProfile[] = [
  {
    ...
    banner: 'https://picsum.photos/seed/sophia-banner/1600/400',
    vibes: ['Date', 'Friend'],
  ...
  },
  {
    ...
    banner: 'https://picsum.photos/seed/liam-banner/1600/400',
    vibes: ['Friend'],
  ...
  },
  {
    ...
    banner: 'https://picsum.photos/seed/chloe-banner/1600/400',
    vibes: ['Spicy', 'Date'],
  ...
  },
   {
    ...
    avatar: 'https://picsum.photos/seed/mason/100',
    banner: 'https://picsum.photos/seed/mason-banner/1600/400',
    vibes: ['Date', 'Friend'],
